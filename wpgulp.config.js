...
module.exports = {
	...
	// Project options.
	projectURL: 'firinn.local', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	bugReport: 'https://github.com/Oddert/firinn/issues', // Where can users report bugs.
